...
/**
 * @brief Construct a new Camera Shake Controller:: Camera Shake Controller object
 * 
 */
CameraShakeController::CameraShakeController(){
    timer         = 0.0; // シェイク時間
    duration      = 0.0; // シェイクの間隔
    magnitude     = 0.0; // シェイクの強さ
    shakeOffset_X = 0.0; // シェイクのX軸のズレ
    shakeOffset_Y = 0.0; // シェイクのY軸のズレ
}
